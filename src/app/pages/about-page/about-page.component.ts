...
import { HeaderComponent, AnnouncementBannerComponent, FooterComponent } from '../../shared/index';
...
@Component({
  ...
  standalone: true,
  imports: [MatGridListModule, HeaderComponent, AnnouncementBannerComponent, FooterComponent],
})
